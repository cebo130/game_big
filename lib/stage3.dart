...
import 'package:game_big/Stage4.dart';

class Stage3 extends StatefulWidget {
  const Stage3({Key? key}) : super(key: key);

  @override
  State<Stage3> createState() => _Stage3State();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Stage 3',style: TextStyle(color: txtCo),),
        centerTitle: true,
      ),
      body: Center(
        child: Container(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: RaisedButton(
                      ...
                      color: touchedA ? Colors.pinkAccent : Colors.blue,
                      onPressed: (){
                        increase();
                        setState(() {
                          user = user+"A";
                  ...
                  Container(
                    ...
                    height: 62,
                    child: RaisedButton(
                      color: touchedB ? Colors.pinkAccent : Colors.blue,
                  ...
                  Container(
                    ...
                    height: 62,
                    child: RaisedButton(
                      color: touchedC ? Colors.pinkAccent : Colors.blue,
              ...
              Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    height: 62,
                    child: RaisedButton(
                      color: touchedD ? Colors.pinkAccent : Colors.blue,
                  ...
                  Container(
                    ...
                    height: 62,
                    child: RaisedButton(
                      color: touchedE ? Colors.pinkAccent : Colors.blue,
                  ...
                  Container(
                    ...
                    height: 62,
                    child: RaisedButton(
                      color: touchedF ? Colors.pinkAccent : Colors.blue,
              ...
              Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    height: 62,
                    child: RaisedButton(
                      color: touchedG ? Colors.pinkAccent : Colors.blue,
                  ...
                  Container(
                    ...
                    height: 62,
                    child: RaisedButton(
                      color: touchedH ? Colors.pinkAccent : Colors.blue,
                  ...
                  Container(
                    ...
                    height: 62,
                    child: RaisedButton(
                      color: touchedI ? Colors.pinkAccent : Colors.blue,
                    ...
                    setState(() {
                      ...
                      if(resCo==true){
                        Navigator.pushReplacement(
                            context, MaterialPageRoute(builder: (_) => Stage4()));
                      }
                    });
                  },
                ),
